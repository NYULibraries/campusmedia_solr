...
<xsl:for-each select="document(concat('http://apps.library.nyu.edu/search/private/campusmedia/?fq=dc.type:equipment&amp;fq=guid:',.))//result/doc/arr[@name='dc.format']/str">
